...
func configureH2Desktop(h profiles.H2Config) { _ = "STUB: not implemented"; return }
...
func configureH2Mobile(h profiles.H2Config) { _ = "STUB: not implemented"; return }

// configureH3Desktop applies the desktop Firefox 148 HTTP/3 SETTINGS chain.
func configureH3Desktop(h profiles.H3Config) { _ = "STUB: not implemented"; return }
...
func configureH3Mobile(h profiles.H3Config) { _ = "STUB: not implemented"; return }
